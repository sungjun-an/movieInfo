    ...
    Column(
        ...
        Text(
            ...
            style = MaterialTheme.typography.titleLarge.copy(
                color = MaterialTheme.colorSchema.secondary
            ),
...
fun ColumnScope.StarRatingBar(
    ...
    Card(
        ...
        Box(
            ...
            val foregroundColor = MaterialTheme.colorSchema.primary.toArgb()
            val starBackgroundColor = MaterialTheme.colorSchema.primaryVariant.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.colorSchema.primaryVariant.copy(
                alpha = 0.05f
            ).toArgb()
